...
import { Gift, Copy, Users, Share2, Check, Euro, Star, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-24 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <Card className="relative overflow-hidden border-2 border-accent/20 bg-gradient-to-br from-accent/5 to-accent/10">
